								...
								<div class="main-menu">
									<ul class="nav-menu">
																...
																<li class="submenu submenu-two">
																	...
																	<ul>
																		...
																		<li><a href="form-fileupload.html">File
																				Uploads</a></li>
																		<li><a href="form-pickers.html">Form Picker</a>
																		</li>
																	</ul>
																</li>
																<li class="submenu submenu-two">
										...
										<li><a href="form-pickers.html">Form Picker</a></li>
														...
														<li class="submenu">
															<a href="javascript:void(0);" class="active">Icons<span
																	class="menu-arrow"></span>
															</a>
															<ul>
																...
																<li><a href="icon-bootstrap.html">Bootstrap Icons</a>
																</li>
																<li><a href="icon-remix.html" class="active">Remix
																		Icons</a></li>
															</ul>
														</li>
														<li class="submenu">
										...
										<div class="card-header">
											<div class="d-flex align-items-center">
												...
												<div>
													...
													<p class="fs-12 fw-medium mb-0"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="5a2d3b28283f341a3f223b372a363f74393537">[email&#160;protected]</a></p>
												</div>
											</div>
										</div>
										<div class="card-body">
							...
							<ul>
								...
								<li class="submenu">
									...
									<ul>
										...
										<li><a href="icon-flag.html">Flag Icons</a></li>
										<li><a href="icon-bootstrap.html">Bootstrap Icons</a></li>
										<li><a href="icon-remix.html" class="active">Remix Icons</a></li>
									</ul>
								</li>
								<li class="submenu">
									<a href="javascript:void(0);">
						...
						<div class="stack-menu">
							<div class="nav flex-column align-items-center nav-pills" role="tablist"
								...
								<div class="row g-2">
									...
									<div class="col-6">
										<a href="#menu-ui-elements" role="tab" class="nav-link active"
