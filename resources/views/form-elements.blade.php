														...
														<li class="submenu">
															...
															<ul>
																<li class="submenu submenu-two">
																	<a href="javascript:void(0);" class="active">Form
																		Elements<span
																			class="menu-arrow inside-submenu"></span></a>
																	<ul>
																		<li><a href="form-basic-inputs.html"
																				>Basic
																				Inputs</a></li>
																		...
																		<li><a href="form-fileupload.html">File
																				Uploads</a></li>
																		<li><a href="form-elements.html" class="active">Form
																				Elements</a></li>
																	</ul>
																</li>
																<li class="submenu submenu-two">
										...
										<li><a href="form-pickers.html">Form Picker</a></li>
														...
														<li class="submenu">
															...
															<ul>
																...
																<li><a href="data-tables.html">Data Table
																	</a></li>
															</ul>
														</li>
															<li class="submenu">
										...
										<div class="card-header">
											<div class="d-flex align-items-center">
												...
												<div>
													...
													<p class="fs-12 fw-medium mb-0"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="aed9cfdcdccbc0eecbd6cfc3dec2cb80cdc1c3">[email&#160;protected]</a></p>
												</div>
											</div>
										</div>
										<div class="card-body">
								...
								<li class="submenu">
									...
									<ul>
										...
										<li class="submenu">
											...
											<ul>
												<li class="submenu submenu-two">
													<a href="javascript:void(0);" class="active">Form Elements<span
															class="menu-arrow inside-submenu"></span></a>
													<ul>
														...
														<li><a href="form-mask.html">Input Masks</a></li>
														<li><a href="form-fileupload.html">File Uploads</a></li>
														<li><a href="form-elements.html" class="active">Form Elements</a></li>
													</ul>
												</li>
												<li class="submenu submenu-two">
													<a href="javascript:void(0);">Layouts<span class="menu-arrow inside-submenu"></span></a>
				...
				<div class="sidebar-right">
					...
					<div class="sidebar-scroll">
						...
						<div class="tab-content" id="v-pills-tabContent">
							...
							<div class="tab-pane show active" id="ui-elements">
								<ul>
									<li class="menu-title"><span>UI INTERFACE</span></li>
									<li class="submenu">
									...
									<li class="submenu ">
										...
										<ul>
											<li class="submenu submenu-two">
												<a href="javascript:void(0);" class="active subdrop">Form Elements<span
														class="menu-arrow inside-submenu"></span></a>
												<ul>
													<li><a href="form-basic-inputs.html" >Basic Inputs</a>
													</li>
													<li><a href="form-checkbox-radios.html" >Checkbox & Radios</a></li>
													<li><a href="form-input-groups.html">Input Groups</a></li>
													<li><a href="form-grid-gutters.html">Grid & Gutters</a></li>
							...
							<div class="stack-menu">
								<div class="nav flex-column align-items-center nav-pills" role="tablist"
									...
									<div class="row g-2">
										...
										<div class="col-6">
											<a href="javascript:void(0);" role="tab" class="nav-link" title="UI Elements"
