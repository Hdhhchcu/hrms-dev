					...
					<div class="col-lg-7 col-md-12 col-sm-12">
						<div class="row justify-content-center align-items-center vh-100 overflow-auto flex-wrap ">
							<div class="col-md-7 mx-auto p-4">
								<form action="reset-password-2.html" class="digit-group">
									<div>
										...
										<div class="">
                                            <div class="text-center mb-3">
                                                ...
                                                <p class="mb-0">Please enter the OTP received to confirm your account ownership. A code has been send to ******<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="cda9a2a88da8b5aca0bda1a8e3aea2a0">[email&#160;protected]</a></p>
                                            </div>
