									...
									<ul class="nav-menu">
										...
										<li class="submenu">
											...
											<ul>
												...
												<li>
													<a href="layout-horizontal-overlay.html" class="active">
						...
						<div class="tab-content" id="v-pills-tabContent">
							...
							<div class="tab-pane fade  show active" id="layout">
								<ul>
									...
									<li><a href="layout-horizontal-overlay.html" class="active"><span>Horizontal Overlay</span></a></li>
							...
							<div class="tab-content">
								...
								<div class="tab-pane fade show active" id="menu-layout">
									<ul class="stack-submenu">
										...
										<li><a href="layout-horizontal-overlay.html" class="active">Horizontal Overlay</a></li>
