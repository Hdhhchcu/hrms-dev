								...
								<div class="main-menu">
									<ul class="nav-menu">
										...
										<li><a href="form-pickers.html">Form Picker</a></li>
														...
														<li class="submenu">
															<a href="javascript:void(0);" class="active">Icons<span class="menu-arrow"></span>
															</a>
															<ul>
												...
												<li><a href="icon-remix.html">Remix Icons</a></li>
																...
																<li><a href="icon-bootstrap.html" class="active">Bootstrap Icons</a></li>
															</ul>
														</li>
														<li class="submenu">
										...
										<div class="card-header">
											<div class="d-flex align-items-center">
												...
												<div>
													...
													<p class="fs-12 fw-medium mb-0"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="88ffe9fafaede6c8edf0e9e5f8e4eda6ebe7e5">[email&#160;protected]</a></p>
												</div>
											</div>
										</div>
										<div class="card-body">
					...
					<ul>
						...
						<li>
							<ul>
								...
								<li class="submenu">
									<a href="javascript:void(0);" class="subdrop active"><i class="ti ti-icons"></i>
						...
						<div class="tab-content" id="v-pills-tabContent">
							...
							<div class="tab-pane fade show active" id="ui-elements">
								<ul>
									...
									<li class="submenu">
										<a href="javascript:void(0);"  class="active">Icons<span class="menu-arrow"></span> </a>
										<ul>
											<li><a href="icon-fontawesome.html">Fontawesome Icons</a></li>
												<li><a href="icon-tabler.html">Tabler Icons</a></li>
												<li><a href="icon-bootstrap.html">Bootstrap Icons</a></li>
						...
						<div class="stack-menu">
							<div class="nav flex-column align-items-center nav-pills" role="tablist" aria-orientation="vertical">
								<div class="row g-2">
									...
									<div class="col-6">
										<a href="#menu-ui-elements" role="tab" class="nav-link active" title="UI Elements" data-bs-toggle="tab" data-bs-target="#menu-ui-elements" aria-selected="false">
							...
							<div class="tab-content">
								...
								<div class="tab-pane fade show active" id="menu-ui-elements">
									<ul class="stack-submenu">
										<li class="submenu">
											<a href="javascript:void(0);">Base UI<span class="menu-arrow"></span></a>
											<ul>
