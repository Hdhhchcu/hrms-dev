													...
													<ul>
														<li class="submenu">
															...
															<ul>
																...
																<li><a href="ui-badges.html" class="active">Badges</a></li>
						...
						<div class="tab-content" id="v-pills-tabContent">
							...
							<div class="tab-pane fade show active" id="ui-elements">
								<ul>
									<li class="menu-title"><span>UI INTERFACE</span></li>
									<li class="submenu">
										<a href="javascript:void(0);" class="active ">Base UI<span class="menu-arrow"></span>
										</a>
										<ul>
											<li><a href="ui-alerts.html">Alerts</a></li>
											<li><a href="ui-accordion.html" class="active">Accordion</a></li>
											<li><a href="ui-avatar.html">Avatar</a></li>
