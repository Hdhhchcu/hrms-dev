										...
										<div class="card-header">
											<div class="d-flex align-items-center">
												...
												<div>
													...
													<p class="fs-12 fw-medium mb-0"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="b6c1d7c4c4d3d8f6d3ced7dbc6dad398d5d9db">[email&#160;protected]</a></p>
												</div>
											</div>
										</div>
										<div class="card-body">
				...
				<div class="twocol-mini">
					...
					<div class="sidebar-left slimscroll">
						<div class="nav flex-column align-items-center nav-pills" id="sidebar-tabs" role="tablist"
							...
							<a href="#" class="nav-link active" title="Projects" data-bs-toggle="tab"
						...
						<div class="stack-menu">
							<div class="nav flex-column align-items-center nav-pills" role="tablist"
								...
								<div class="row g-2">
									...
									<div class="col-6">
										<a href="#menu-project" role="tab" class="nav-link active" title="Projects"
					...
					<div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
						<div class="me-2 mb-2">
							<div class="d-flex align-items-center border bg-white rounded p-1 me-2 icon-list">
								<a href="clients.html" class="btn btn-icon btn-sm me-1"><i class="ti ti-list-tree"></i></a>
								<a href="clients-grid.html" class="btn btn-icon btn-sm active bg-primary text-white"><i class="ti ti-layout-grid"></i></a>
							</div>
						</div>
						<div class="me-2 mb-2">
							<div class="dropdown">
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start mb-2">
									...
									<div>
										<a href="client-details.html" class="avatar avatar-xl avatar-rounded online border p-1 border-primary rounded-circle">
								...
								<div class="text-center mb-3">
									<h6 class="mb-1"><a href="client-details.html">Michael Walker</a></h6>
					...
					<div class="col-xl-3 col-lg-4 col-md-6">
						<div class="card">
							<div class="card-body">
								...
								<div class="text-center mb-3">
									<h6 class="mb-1"><a href="client-details.html">Sophie Headrick</a></h6>
					...
					<div class="col-xl-3 col-lg-4 col-md-6">
						<div class="card">
							<div class="card-body">
								...
								<div class="text-center mb-3">
									<h6 class="mb-1"><a href="client-details.html">Cameron Drake</a></h6>
					...
					<div class="col-xl-3 col-lg-4 col-md-6">
						<div class="card">
							<div class="card-body">
								...
								<div class="text-center mb-3">
									<h6 class="mb-1"><a href="client-details.html">Doris Crowley</a></h6>
					...
					<div class="col-xl-3 col-lg-4 col-md-6">
						<div class="card">
							<div class="card-body">
								...
								<div class="text-center mb-3">
									<h6 class="mb-1"><a href="client-details.html">Thomas Bordelon</a></h6>
									<span class="badge bg-pink-transparent fs-10 fw-medium">Manager</span>
								</div>
								<div>
					...
					<div class="col-xl-3 col-lg-4 col-md-6">
						<div class="card">
							<div class="card-body">
								...
								<div class="text-center mb-3">
									<h6 class="mb-1"><a href="client-details.html">Kathleen Gutierrez</a></h6>
									<span class="badge bg-pink-transparent fs-10 fw-medium">Director</span>
								</div>
								<div>
					...
					<div class="col-xl-3 col-lg-4 col-md-6">
						<div class="card">
							<div class="card-body">
								...
								<div class="text-center mb-3">
									<h6 class="mb-1"><a href="client-details.html">Bruce Wright</a></h6>
									<span class="badge bg-pink-transparent fs-10 fw-medium">CEO</span>
								</div>
								<div>
					...
					<div class="col-xl-3 col-lg-4 col-md-6">
						<div class="card">
							<div class="card-body">
								...
								<div class="text-center mb-3">
									<h6 class="mb-1"><a href="client-details.html">Estelle Morgan</a></h6>
									<span class="badge bg-pink-transparent fs-10 fw-medium">Manager</span>
								</div>
								<div>
					...
					<div class="col-xl-3 col-lg-4 col-md-6">
						<div class="card">
							<div class="card-body">
								...
								<div class="text-center mb-3">
									<h6 class="mb-1"><a href="client-details.html">Stephen Dias</a></h6>
									<span class="badge bg-pink-transparent fs-10 fw-medium">CEO</span>
								</div>
								<div>
					...
					<div class="col-xl-3 col-lg-4 col-md-6">
						<div class="card">
							<div class="card-body">
								...
								<div class="text-center mb-3">
									<h6 class="mb-1"><a href="client-details.html">Angela Thomas</a></h6>
									<span class="badge bg-pink-transparent fs-10 fw-medium">Consultant</span>
								</div>
								<div>
					...
					<div class="col-xl-3 col-lg-4 col-md-6">
						<div class="card">
							<div class="card-body">
								...
								<div class="text-center mb-3">
									<h6 class="mb-1"><a href="client-details.html">Charles  Ramos</a></h6>
									<span class="badge bg-pink-transparent fs-10 fw-medium">CEO</span>
								</div>
								<div>
					...
					<div class="col-xl-3 col-lg-4 col-md-6">
						<div class="card">
							<div class="card-body">
								...
								<div class="text-center mb-3">
									<h6 class="mb-1"><a href="client-details.html">Shirley Begaye</a></h6>
									<span class="badge bg-pink-transparent fs-10 fw-medium">Manager</span>
								</div>
								<div>
				...
				<div class="modal-content">
					<div class="modal-body text-center">
						...
						<div class="d-flex justify-content-center">
							...
							<a href="clients-grid.html" class="btn btn-danger">Yes, Delete</a>
						</div>
					</div>
				</div>
			</div>
