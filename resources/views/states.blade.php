											...
											<ul>
												...
												<li class="submenu">
													...
													<ul>
														...
														<li class="submenu">
															<a href="javascript:void(0);" class="active subdrop">Locations<span class="menu-arrow"></span></a>
															<ul>
																<li><a href="countries.html">Countries</a></li>
																<li><a href="states.html" class="active">States</a></li>
				...
				<div class="modal-content">
					<div class="modal-body text-center">
						...
						<div class="d-flex justify-content-center">
							...
							<a href="states.html" class="btn btn-danger">Yes, Delete</a>
						</div>
					</div>
				</div>
			</div>
