									...
									<ul class="nav-menu">
										...
										<li class="submenu">
											...
											<ul>
												...
												<li>
													<a href="layout-horizontal-box.html" class="active">
										...
										<div class="card-header">
											<div class="d-flex align-items-center">
												...
												<div>
													...
													<p class="fs-12 fw-medium mb-0"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="7106100303141f311409101c011d145f121e1c">[email&#160;protected]</a></p>
												</div>
											</div>
										</div>
										<div class="card-body">
						...
						<div class="tab-content" id="v-pills-tabContent">
							...
							<div class="tab-pane fade  show active" id="layout">
								<ul>
									...
									<li><a href="layout-horizontal-box.html" class="active"><span>Horizontal Box</span></a></li>
							...
							<div class="tab-content">
								...
								<div class="tab-pane fade show active" id="menu-layout">
									<ul class="stack-submenu">
										...
										<li><a href="layout-horizontal-box.html" class="active">Horizontal Box</a></li>
