										...
										<div class="card-header">
											<div class="d-flex align-items-center">
												...
												<div>
													...
													<p class="fs-12 fw-medium mb-0"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="6c1b0d1e1e09022c09140d011c0009420f0301">[email&#160;protected]</a></p>
												</div>
											</div>
										</div>
										<div class="card-body">
					...
					<div class="card-body p-0">
						<div class="custom-datatable-filter table-responsive">
							<table class="table datatable">
								...
								<tbody>
									<tr>
										<td><a href="invoice-details.html" class="link-info"> Inv-001</a></td>
										<td>
                                    ...
                                    <tr>
										<td><a href="invoice-details.html" class="link-info">Inv-002</a></td>
										<td>
											<div class="d-flex align-items-center file-name-icon">
												<a href="#" class="avatar avatar-md avatar-rounded">
                                    ...
                                    <tr>
										<td><a href="invoice-details.html" class="link-info">Inv-003</a></td>
										<td>
											<div class="d-flex align-items-center file-name-icon">
												<a href="#" class="avatar avatar-md avatar-rounded">
                                        ...
                                        <tr>
											<td><a href="invoice-details.html" class="link-info">Inv-004</a></td>
                                            <td>
                                                <div class="d-flex align-items-center file-name-icon">
                                                    <a href="#" class="avatar avatar-md avatar-rounded">
                                            ...
                                            <tr>
												<td><a href="invoice-details.html" class="link-info">Inv-005</a></td>
                                                <td>
                                                    <div class="d-flex align-items-center file-name-icon">
                                                        <a href="#" class="avatar avatar-md avatar-rounded">
                                            ...
                                            <tr>
												<td><a href="invoice-details.html" class="link-info">Inv-006</a></td>
                                                <td>
                                                    <div class="d-flex align-items-center file-name-icon">
                                                        <a href="#" class="avatar avatar-md avatar-rounded">
                                            ...
                                            <tr>
												<td><a href="invoice-details.html" class="link-info">Inv-007</a></td>
                                                <td>
                                                    <div class="d-flex align-items-center file-name-icon">
                                                        <a href="#" class="avatar avatar-md avatar-rounded">
                                            ...
                                            <tr>
												<td><a href="invoice-details.html" class="link-info">Inv-008</a></td>
                                                <td>
                                                    <div class="d-flex align-items-center file-name-icon">
                                                        <a href="#" class="avatar avatar-md avatar-rounded">
                                            ...
                                            <tr>
												<td><a href="invoice-details.html" class="link-info">Inv-009</a></td>
                                                <td>
                                                    <div class="d-flex align-items-center file-name-icon">
                                                        <a href="#" class="avatar avatar-md avatar-rounded">
                                            ...
                                            <tr>
												<td><a href="invoice-details.html" class="link-info">Inv-010</a></td>
                                                <td>
                                                    <div class="d-flex align-items-center file-name-icon">
                                                        <a href="#" class="avatar avatar-md avatar-rounded">
