                                        ...
                                        <li class="submenu">
                                            ...
                                            <ul>
                                                ...
                                                <li class="submenu">
                                                    ...
                                                    <ul>
                                                        <li><a href="performance-indicator.html">PerformanceIndicator</a></li>
                                            ...
                                            <ul>
                                                ...
                                                <li class="submenu">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li class="submenu">
                                                            <a href="javascript:void(0);" class="active subdrop">System Settings<span class="menu-arrow"></span></a>
                                                            <ul>
                                                                ...
                                                                <li><a href="maintenance-mode.html" class="active">Maintenance Mode</a></li>
                                                            </ul>
                                                        </li>
                                                        <li class="submenu">
                                            ...
                                            <div class="border-bottom mb-3 pb-3">
                                                <a href="activity.html">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <p class="mb-1">New student record 
																<span class="text-dark fw-semibold"> George</span> is created by <span class="text-dark fw-semibold">
																	Teressa
																</span>
															</p>
                                                            <span>2 hrs ago</span>
                            ...
                            <ul>
                                ...
                                <li class="submenu">
                                    ...
                                    <ul>
                                        ...
                                        <li class="submenu submenu-two">
                                            <a href="javascript:void(0);" class="active subdrop">System Settings<span class="menu-arrow inside-submenu"></span></a>
                                            <ul>
                                                <li><a href="email-settings.html">Email Settings</a></li>
                                                <li><a href="email-template.html">Email Templates</a></li>
                                                <li><a href="sms-settings.html">SMS Settings</a></li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-column list-group settings-list">
                                    <a href="email-settings.html" class="d-inline-flex align-items-center rounded py-2 px-3">Email Settings</a>
                                    ...
                                    <a href="gdpr.html" class="d-inline-flex align-items-center rounded py-2 px-3">GDPR Cookies</a>
                                    <a href="maintenance-mode.html" class="d-inline-flex align-items-center active rounded py-2 px-3"><i class="ti ti-arrow-badge-right me-2"></i>Maintenance Mode</a>
                                </div>
                            </div>
                        </div>
                    </div>
