...
{{-- ---------------------- Group Channel Add User Modal ---------------------- --}}
<div class="app-modal group-modal-user" data-name="addGroupUser">
    <div class="app-modal-container">
        <div class="app-modal-card" data-name="addGroupUser" data-modal='0'>
            <form id="addGroupUserForm" action="{{ route('group-chat.addgroupuser') }}" enctype="multipart/form-data" method="POST">
                @csrf
                <div class="app-modal-header">
                ...
                <div class="app-modal-body">
                    ...
                    <div class="form-control">
                        <label class="form-label" for="group_name_user">Group Name : </label>
                        <input type="text" class="form-input" readonly name="group_name" id="group_name_user">
                    </div>
                    <div class="form-control">
                        <label class="form-label" for="search">Select user(s) to the group</label>
                        <input class="form-input user-search" type="text" name="search" placeholder="Search"/>
                ...
                <div class="app-modal-footer">
                    <a href="javascript:void(0)" class="app-btn cancel">Cancel</a>
                    <input type="submit" class="app-btn a-btn-success adduser" value="Save Changes" />
                </div>
            </form>
        </div>
    </div>
...
{{-- ---------------------- Edit Chat Modal ---------------------- --}}
<div class="app-modal edit_chat" data-name="editChat">
    <div class="app-modal-container">
        <div class="app-modal-card" data-name="editChat" data-modal='0'>
            <form id="editChatForm" action="{{route('edit.chat')}}" onsubmit="editChatMessage(event)" enctype="multipart/form-data" method="POST">
                @csrf
                <div class="app-modal-header">
                  Edit Chat 
                </div>
                <div class="app-modal-body">
                    ...
                    <div class="form-control">
                        <label class="form-label" for="message">Type New Chat</label>
                        <input class="form-input" type="text" name="message" id="messageEdit"
                               placeholder="Enter Message"
                               required="required"
                        />

                        <input type="hidden" id="ChatIDMessage" >
                    </div>
        
                </div>
                <div class="app-modal-footer">
                    <a href="javascript:void(0)" class="app-btn cancel">Cancel</a>
                    <input type="submit" class="app-btn a-btn-success updateChat" value="Save Changes" />
                </div>
            </form>
        </div>
    </div>
