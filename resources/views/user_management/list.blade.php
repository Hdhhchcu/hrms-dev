		...
		<div class="my-auto mb-2">
			...
			<nav>
				<ol class="breadcrumb mb-0">
					...
					<li class="breadcrumb-item active" aria-current="page">User Management List</li>
				</ol>
			</nav>
		</div>
				...
				<table class="table datatable">
					...
					<tbody>
						...
						<tr>
							...
							<td><button class="btn btn-info btn-sm">{{$e->email}}</button></td>
							<td><button class="btn btn-success btn-sm">{{$e->phone}}</button></td>
