...
return [
    ...
    |-------------------------------------
    */
    'name' => env('CHATIFY_NAME', 'Codleo Chat Messenger'),
    ...
    |-------------------------------------
    */
    'storage_disk_name' => env('CHATIFY_STORAGE_DISK', 'chat'),
    ...
    */
    'routes' => [
        'prefix' => env('CHATIFY_ROUTES_PREFIX', 'chating'),
    ...
    */
    'sounds' => [
        'enabled' => true,
        'public_path' => 'chatappguddugroupchat/sounds/chatify',
