									...
									<ul class="nav-menu">
										...
										<li class="submenu">
											...
											<ul>
												...
												<li><a href="api-keys.html" class="active"><span>API Keys</span></a></li>
										...
										<div class="card-header">
											<div class="d-flex align-items-center">
												...
												<div>
													...
													<p class="fs-12 fw-medium mb-0"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="d6a1b7a4a4b3b896b3aeb7bba6bab3f8b5b9bb">[email&#160;protected]</a></p>
												</div>
											</div>
										</div>
										<div class="card-body">
				...
				<div class="modal-content">
					<div class="modal-body text-center">
						...
						<div class="d-flex justify-content-center">
							...
							<a href="api-keys.html" class="btn btn-danger">Yes, Delete</a>
						</div>
					</div>
				</div>
			</div>
