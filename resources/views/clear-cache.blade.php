													...
													<ul>
														...
														<li class="submenu">
															...
															<ul>
																...
																<li><a href="clear-cache.html" class="active">Clear Cache</a></li>
															</ul>
														</li>
													</ul>
												</li>
										...
										<div class="card-header">
											<div class="d-flex align-items-center">
												...
												<div>
													...
													<p class="fs-12 fw-medium mb-0"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="b1c6d0c3c3d4dff1d4c9d0dcc1ddd49fd2dedc">[email&#160;protected]</a></p>
												</div>
											</div>
										</div>
										<div class="card-body">
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex flex-column list-group settings-list">
									...
									<a href="clear-cache.html" class="d-inline-flex align-items-center rounded active py-2 px-3"><i class="ti ti-arrow-badge-right me-2"></i>Clear Cache</a>
								</div>
							</div>
						</div>
					</div>
