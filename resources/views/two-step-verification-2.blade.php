					...
					<div class="col-lg-7 col-md-12 col-sm-12">
						<div class="row justify-content-center align-items-center vh-100 overflow-auto flex-wrap ">
							<div class="col-md-7 mx-auto p-4">
								<form action="login-2.html" class="digit-group">
									<div>
										...
										<div class="">
                                            <div class="text-center mb-3">
                                                ...
                                                <p class="mb-0">Please enter the OTP received to confirm your account ownership. A code has been send to ******<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="b8dcd7ddf8ddc0d9d5c8d4dd96dbd7d5">[email&#160;protected]</a></p>
                                            </div>
