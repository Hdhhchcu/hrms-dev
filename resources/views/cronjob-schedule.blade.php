										...
										<div class="card-header">
											<div class="d-flex align-items-center">
												...
												<div>
													...
													<p class="fs-12 fw-medium mb-0"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="5324322121363d13362b323e233f367d303c3e">[email&#160;protected]</a></p>
												</div>
											</div>
										</div>
										<div class="card-body">
                            ...
                            <div class="card-header px-0 mx-3">
                                <div class="row g-3 align-items-center">
                                    <div class="col-md-6 col-sm-4">
                                        <h6 class="fw-medium d-inline-flex align-items-center mb-3 mb-sm-0"><a href="cronjob.html">
                                    ...
                                    <div class="col-md-6 col-sm-8">
                                        <div class="d-flex justify-content-sm-end align-items-center flex-wrap row-gap-2">
                                            <a href="add-language.html" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add_cronjobschedule"><i class="ti ti-circle-plus me-2"></i>Add Schedule</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
		...
		<div class="modal fade" id="add_cronjobschedule">
			<div class="modal-dialog modal-dialog-centered modal-md">
				<div class="modal-content">
					...
					<form action="cronjob-schedule.html">
