			...
			<div class="w-100 overflow-hidden position-relative flex-wrap d-block vh-100">
				<div class="row justify-content-center align-items-center vh-100 overflow-auto flex-wrap ">
					<div class="col-md-4 mx-auto vh-100">
						<form action="reset-password-3.html" class="digit-group vh-100">
							<div class="vh-100 d-flex flex-column justify-content-between p-4 pb-0">
								...
								<div class="">
									<div class="text-center mb-3">
										...
										<p class="mb-0">Please enter the OTP received to confirm your account ownership. A code has been send to ******<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="0b6f646e4b6e736a667b676e25686466">[email&#160;protected]</a></p>
									</div>
