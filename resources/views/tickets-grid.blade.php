                                                    ...
                                                    <ul>
                                                        ...
                                                        <li class="submenu submenu-two"><a href="javascript:void(0);">Multilevel 2<span
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li class="submenu submenu-two submenu-three"><a href="javascript:void(0);">Multilevel 2.2<span
                                        ...
                                        <div class="card-header">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="fs-12 fw-medium mb-0"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="dea9bfacacbbb09ebba6bfb3aeb2bbf0bdb1b3">[email&#160;protected]</a></p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-body">
                        ...
                        <li>
                            <ul>
                                ...
                                <li class="submenu">
                                    ...
                                    <ul>
                                        <li><a href="tickets-grid.html" class="active">Tickets</a></li>
                    ...
                    <div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
                        <div class="me-2 mb-2">
                            <div class="d-flex align-items-center border bg-white rounded p-1 me-2 icon-list">
                                <a href="tickets.html" class="btn btn-icon btn-sm me-1"><i class="ti ti-list-tree"></i></a>
                                <a href="tickets-grid.html" class="btn btn-icon btn-sm active bg-primary text-white"><i class="ti ti-layout-grid"></i></a>
                            </div>
                        </div>
                        <div class="me-2 mb-2">
                            <div class="dropdown">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-start mb-2">
                                    ...
                                    <div>
                                        <a href="ticket-details.html" class="avatar avatar-xl avatar-rounded online border p-1 border-primary rounded-circle">
                                ...
                                <div class="text-center mb-3">
                                    <h6 class="mb-1"><a href="ticket-details.html">Laptop Issue</a></h6>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="text-center mb-3">
                                    <h6 class="mb-1"><a href="ticket-details.html">Payment Issue</a></h6>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="text-center mb-3">
                                    <h6 class="mb-1"><a href="ticket-details.html">Bug Report</a></h6>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="text-center mb-3">
                                    <h6 class="mb-1"><a href="ticket-details.html">Access Denied</a></h6>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="text-center mb-3">
                                    <h6 class="mb-1"><a href="ticket-details.html">Display Glitch</a></h6>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="text-center mb-3">
                                    <h6 class="mb-1"><a href="ticket-details.html">Security Alert</a></h6>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="text-center mb-3">
                                    <h6 class="mb-1"><a href="ticket-details.html">Connectivity Issue</a></h6>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="text-center mb-3">
                                    <h6 class="mb-1"><a href="ticket-details.html">Update Error</a></h6>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="text-center mb-3">
                                    <h6 class="mb-1"><a href="ticket-details.html">Login Failure</a></h6>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="text-center mb-3">
                                    <h6 class="mb-1"><a href="ticket-details.html">Server Timeout</a></h6>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="text-center mb-3">
                                    <h6 class="mb-1"><a href="ticket-details.html">Email Client Setup</a></h6>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="text-center mb-3">
                                    <h6 class="mb-1"><a href="ticket-details.html">Application Crashing</a></h6>
                ...
                <div class="modal-content">
                    <div class="modal-body text-center">
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <a href="tickets-grid.html" class="btn btn-danger">Yes, Delete</a>
                        </div>
                    </div>
                </div>
            </div>
