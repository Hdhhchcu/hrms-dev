					...
					<ul>
						...
						<li>
							<ul>
								...
								<li class="submenu">
									<a href="javascript:void(0);" class="active subdrop"><i class="ti ti-chart-line"></i>
							...
							<ul>
								...
								<li class="submenu">
									...
									<ul>
										...
										<li class="submenu">
											<a href="javascript:void(0);" class="active">Charts<span
													class="menu-arrow"></span>
											</a>
											<ul>
												<li><a href="chart-apex.html">Apex Charts</a></li>
						...
						<div class="tab-content" id="v-pills-tabContent">
							...
							<div class="tab-pane show active" id="ui-elements">
								<ul>
									...
									<li class="submenu">
										<a href="javascript:void(0);" class="active subdrop">Charts<span
												class="menu-arrow"></span>
										</a>
										<ul>
											<li><a href="chart-apex.html">Apex Charts</a></li>
