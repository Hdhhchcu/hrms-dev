										...
										<div class="card-header">
											<div class="d-flex align-items-center">
												...
												<div>
													...
													<p class="fs-12 fw-medium mb-0"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="d8afb9aaaabdb698bda0b9b5a8b4bdf6bbb7b5">[email&#160;protected]</a></p>
												</div>
											</div>
										</div>
										<div class="card-body">
				...
				<div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
					...
					<div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
						<div class="d-flex align-items-center border rounded p-1 me-2">
							...
							<a href="todo.html" class="btn btn-icon btn-sm active bg-primary text-white"><i class="ti ti-table"></i></a>
						</div>
						<div class="">
