...
<div class="content">
	...
	<div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
		<div class="my-auto mb-2">
			<h6 class="fw-medium d-inline-flex align-items-center mb-3 mb-sm-0"><a href="{{url('')}}">
					<i class="ti ti-arrow-left me-2"></i>Background Verification Details</a>
			</h6>
		</div>
			...
			<div class="card card-bg-1">
				<div class="card-body p-0">
					<span class="avatar avatar-xl avatar-rounded border border-2 border-white m-auto d-flex mb-2">
						<img src="{{url('')}}/{{($backgrounddata->sign_image!='')?$backgrounddata->sign_image:'images/employee/user.png'}}" class="w-auto h-auto" alt="Img">
					</span>
					<div class="text-center px-3 pb-3 border-bottom">
						...
						<div>
							...
							<div class="d-flex align-items-center justify-content-between mb-2">
								...
								<p class="text-white badge badge-danger">///</p>
							</div>
							<div class="d-flex align-items-center justify-content-between mb-2">
								<span class="d-inline-flex align-items-center">
					...
					<div class="p-3 border-bottom">
						...
						<div class="d-flex align-items-center justify-content-between mb-2">
							...
							<a href="javascript:void(0);" class="text-info d-inline-flex align-items-center"><span>///</span><i class="ti ti-copy text-dark ms-2"></i></a>
						</div>
						<div class="d-flex align-items-center justify-content-between mb-2">
							<span class="d-inline-flex align-items-center">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="mb-3">
								...
								<input type="hidden" value="{{$backgrounddata->id}}" name="emp_id">
								@csrf
					...
					<div class="row">
						...
						<div class="col-md-3">
							<div class="mb-3">
								...
								<input type="hidden" name="emp_id" value="{{$backgrounddata->id}}">
								@csrf
