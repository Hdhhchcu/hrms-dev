														...
														<li class="submenu">
															...
															<ul>
																...
																<li><a href="approval-settings.html">Approval
																		Settings</a></li>
																<li><a href="invoice-settings.html" class="active">Invoice Settings</a>
																</li>
										...
										<div class="card-header">
											<div class="d-flex align-items-center">
												...
												<div>
													...
													<p class="fs-12 fw-medium mb-0"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="5522342727303b15302d34382539307b363a38">[email&#160;protected]</a></p>
												</div>
											</div>
										</div>
										<div class="card-body">
									...
									<ul>
										...
										<li class="submenu submenu-two">
											...
											<ul>
												...
												<li><a href="invoice-settings.html" class="active">Invoice Settings</a></li>
												<li><a href="leave-type.html">Leave Type</a></li>
												<li><a href="custom-fields.html">Custom Fields</a></li>
											</ul>
										</li>
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex flex-column list-group settings-list">
									<a href="salary-settings.html" class="d-inline-flex align-items-center rounded  py-2 px-3">Profile Settings</a>
									<a href="approval-settings.html" class="d-inline-flex align-items-center rounded py-2 px-3">Approval Settings</a>
									<a href="invoice-settings.html" class="d-inline-flex align-items-center rounded active py-2 px-3"><i class="ti ti-arrow-badge-right me-2"></i>Invoice Settings</a>
									<a href="leave-type.html" class="d-inline-flex align-items-center rounded py-2 px-3">Leave Type</a>
