...
<div class="content">
	...
	<div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
		...
		<div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
			...
			<div class="mb-2">
				<a href="#" data-bs-toggle="modal" data-bs-target="#add_event" class="btn btn-primary d-flex align-items-center"><i class="ti ti-circle-plus me-2"></i>Add Event</a>
			</div>
...
<div class="modal fade" id="event_modal">
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p class="d-flex align-items-center fw-medium text-black mb-3"><i class="ti ti-calendar-check text-default me-2"></i><span id="startdate"></span> <span class="mx-2 d-none">to</span> <span id="enddate"></span></p>
				<p class="d-flex align-items-center fw-medium text-black mb-3"><i class="ti ti-calendar-check text-default me-2"></i> <span id="starttime"></span> <span class="mx-2">to</span> <span id="endtime"></span></p>
				<p class="d-flex align-items-center fw-medium text-black mb-0"><i class="ti ti-calendar-check text-default me-2"></i> <span id="description"></span> </p>
			</div>
		</div>
	</div>
</div>
...
<script>
	if ($('#customcalendar').length > 0) {
		document.addEventListener('DOMContentLoaded', function() {
			...
			$.get("{{url('event/all')}}", function(data) {
				// console.log(data);
				for (x in data) {
					// console.log(data[x]);
					$events[x] = {
				...
				var calendar = new FullCalendar.Calendar(calendarEl, {
					...
					eventClick: function(info) {
						...
						// document.getElementById('enddate').innerText = info.event.extendedProps.enddate;
						document.getElementById('starttime').innerText = info.event.extendedProps.starttime;
						document.getElementById('endtime').innerText = info.event.extendedProps.endtime;
						document.getElementById('description').innerText = info.event.extendedProps.description;
					},
					editable: true,
