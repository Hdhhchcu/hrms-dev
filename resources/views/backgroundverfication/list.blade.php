...
<div class="content">
	...
	<div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
		<div class="my-auto mb-2">
			<h2 class="mb-1">Background Verification</h2>
			<nav>
		...
		<div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
			...
			<div class="mb-2">
				<a href="{{url('backgroundverification')}}" target="_blank" class="btn btn-primary d-flex align-items-center"><i class="ti ti-circle-plus me-2"></i>Add Background Verification</a>
			</div>
				...
				<div class="card-body d-flex align-items-center justify-content-between">
					<div class="d-flex align-items-center overflow-hidden">
						...
						<div class="ms-2 overflow-hidden">
							<p class="fs-12 fw-medium mb-1 text-truncate">Total Background Verification</p>
							<h4>{{$allbackground->count()}}</h4>
						</div>
					</div>
					<div>
			...
			<div class="custom-datatable-filter table-responsive">
				<table class="table datatable">
					...
					<tbody>
						...
						@foreach($allbackground as $e)
						<tr>
			
							<td><a class="btn btn-primary btn-sm" href="#">{{$e->name}} {{$e->surname}}</a></td>
							<td> <button class="btn btn-secondary btn-sm">{{$e->father_name}}</button></td>
							<td><button class="btn btn-outline-info  btn-sm m-1">{{$e->mobile}}</button> </td> <td><button class="btn btn-outline-secondary btn-sm m-1">{{$e->state}}</button></td>
							<td><button class="btn btn-outline-danger btn-sm">{{$e->postcode}}</button></td>
							<td>
						 
						
								<div class="action-icon d-inline-flex">
									<a href="{{url('backgroundverification/edit')}}/{{$e->id}}" class="me-2"><i class="ti ti-eye"></i></a>
									<a class="edit_team d-none" href="{{url('backgroundverification/edit')}}/{{$e->id}}" class="me-2" data-bs-toggle="modal" data-bs-target="#edit_team"><i class="ti ti-edit"></i></a>
									<a class="delete_team" href="{{url('backgroundverification/delete')}}/{{$e->id}}" data-bs-toggle="modal" data-bs-target="#delete_modal"><i class="ti ti-trash"></i></a>
								</div>
