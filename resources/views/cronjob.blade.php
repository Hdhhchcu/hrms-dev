									...
									<ul class="nav-menu">
										...
										<li class="submenu">
											...
											<ul>
												...
												<li class="submenu">
													<a href="javascript:void(0);" class="active"><span>Settings</span>
														<span class="menu-arrow"></span>
													</a>
													<ul>
														<li class="submenu">
														...
														<li class="submenu">
															<a href="javascript:void(0);" class="active">Other Settings<span
																	class="menu-arrow"></span></a>
															<ul>
																<li><a href="custom-css.html">Custom CSS</a></li>
																<li><a href="custom-js.html" >Custom JS</a></li>
																<li><a href="cronjob.html"class="active">Cronjob</a></li>
										...
										<div class="card-header">
											<div class="d-flex align-items-center">
												...
												<div>
													...
													<p class="fs-12 fw-medium mb-0"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="7d0a1c0f0f18133d18051c100d1118531e1210">[email&#160;protected]</a></p>
												</div>
											</div>
										</div>
										<div class="card-body">
							...
							<ul>
								...
								<li class="submenu">
									...
									<ul>
										...
										<li class="submenu submenu-two">
											<a href="javascript:void(0);" class="active subdrop">Other Settings<span
													class="menu-arrow inside-submenu"></span></a>
											<ul>
												<li><a href="custom-css.html">Custom CSS</a></li>
												<li><a href="custom-js.html">Custom JS</a></li>
				...
				<div class="twocol-mini">
					...
					<div class="sidebar-left slimscroll">
						<div class="nav flex-column align-items-center nav-pills" id="sidebar-tabs" role="tablist"
							...
							<a href="#" class="nav-link active" title="Content" data-bs-toggle="tab"
						...
						<div class="tab-content" id="v-pills-tabContent">
							...
							<div class="tab-pane fade show active" id="administration">
								<ul>
									...
									<li class="submenu">
										<a href="javascript:void(0);" class="active subdrop">Other Settings<span class="menu-arrow"></span></a>
										<ul>
											<li><a href="custom-css.html" >Custom CSS</a></li>
											<li><a href="custom-js.html">Custom JS</a></li>
											<li><a href="cronjob.html" class="active">Cronjob</a></li>
		...
		<div class="page-wrapper">
			<div class="content">
				...
				<ul class="nav nav-tabs nav-tabs-solid bg-transparent border-bottom mb-3">
					...
					<li class="nav-item">
						<a class="nav-link active" href="custom-css.html"><i class="ti ti-settings-2 me-2"></i>Other Settings</a>
					</li>
				</ul>
				<div class="row">
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex flex-column list-group settings-list">
									<a href="custom-css.html" class="d-inline-flex align-items-center rounded py-2 px-3">Custom CSS</a>
									<a href="custom-js.html" class="d-inline-flex align-items-center rounded py-2 px-3">Custom JS</a>
									<a href="cronjob.html" class="d-inline-flex align-items-center rounded active py-2 px-3"><i class="ti ti-arrow-badge-right me-2"></i>Cronjob</a>
									<a href="storage-settings.html" class="d-inline-flex align-items-center rounded py-2 px-3">Storage</a>
									<a href="ban-ip-address.html" class="d-inline-flex align-items-center rounded py-2 px-3">Ban IP Address</a>
									<a href="backup.html" class="d-inline-flex align-items-center rounded py-2 px-3">Backup</a>
									<a href="clear-cache.html" class="d-inline-flex align-items-center rounded py-2 px-3">Clear Cache</a>
								</div>
							</div>
						</div>
					</div>
                                ...
                                <div class="row g-3 align-items-center">
                                    ...
                                    <div class="col-md-6 col-sm-8">
                                        <div class="d-flex justify-content-sm-end align-items-center flex-wrap row-gap-2">
                                            <a href="cronjob-schedule.html" class="btn btn-dark me-2"><i class="ti ti-clock-hour-4 me-2"></i>Cron Schedule</a>
