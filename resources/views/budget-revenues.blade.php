									...
									<ul class="nav-menu">
										...
										<li class="submenu">
											...
											<ul>
												...
												<li class="submenu">
													<a href="javascript:void(0);" class="active subdrop"><span>Accounting</span>
														<span class="menu-arrow"></span>
													</a>
													<ul>
														...
														<li><a href="budget-revenues.html" class="active">Budget Revenues</a></li>
													</ul>
												</li>
												<li class="submenu">
										...
										<div class="card-header">
											<div class="d-flex align-items-center">
												...
												<div>
													...
													<p class="fs-12 fw-medium mb-0"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="f285938080979cb2978a939f829e97dc919d9f">[email&#160;protected]</a></p>
												</div>
											</div>
										</div>
										<div class="card-body">
		...
		<div class="modal fade" id="add_new_expense">
			<div class="modal-dialog modal-dialog-centered modal-md">
				<div class="modal-content">
					...
					<form action="budget-revenues.html">
		...
		<div class="modal fade" id="edit_new_expense">
			<div class="modal-dialog modal-dialog-centered modal-md">
				<div class="modal-content">
					...
					<form action="budget-expenses.html">
						<div class="modal-body pb-0">
							<div class="row">
								<div class="col-md-12">
									<div class="mb-3">
				...
				<div class="modal-content">
					<div class="modal-body text-center">
						...
						<div class="d-flex justify-content-center">
							...
							<a href="budget-revenues.html" class="btn btn-danger">Yes, Delete</a>
						</div>
					</div>
				</div>
			</div>
