				...
				<div class="row justify-content-between align-items-center mb-4">
					<div class="col-md-12">
						<div class="d-flex justify-content-between align-items-center">
							<h6 class="fw-medium d-inline-flex align-items-center mb-3 mb-sm-0"><a href="clients.html">
							...
							<div class="card-body p-0">
								...
								<div class="text-center px-3 pb-3 border-bottom">
									...
									<div>
										...
										<div class="row gx-2 mt-3">
											<div class="col-6">
												<div>
													<a href="voice-call.html" class="btn btn-dark w-100"><i class="ti ti-phone-call me-1"></i>Call</a>
												</div>
											</div>
											<div class="col-6">
												<div>
								...
								<div class="p-3 border-bottom">
									...
									<div class="d-flex align-items-center justify-content-between mb-2">
										...
										<a href="javascript:void(0);" class="text-info d-inline-flex align-items-center"><span class="__cf_email__" data-cfemail="cebeabbcbcafa2bafffc8eabb6afa3bea2abe0ada1a3">[email&#160;protected]</span><i class="ti ti-copy text-dark ms-2"></i></a>
									</div>
									<div class="d-flex align-items-center justify-content-between">
										<span class="d-inline-flex align-items-center">
															...
															<div class="card">
																<div class="card-body">
																	<div class="d-flex align-items-center pb-3 mb-3 border-bottom">
																		...
																		<div>
																			<h6 class="mb-1"><a href="project-details.html">Video Calling App</a></h6>
																			<div class="d-flex align-items-center">
																				<span>22 tasks</span>
																				<span class="mx-1"><i class="ti ti-point-filled text-primary"></i></span>
																				<span>15 Completed</span>
