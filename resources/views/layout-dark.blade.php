									...
									<ul class="nav-menu">
										...
										<li class="submenu">
											...
											<ul>
												...
												<li>
													<a href="layout-dark.html" class="active">
														<span>Dark</span>
													</a>
												</li>
											</ul>
										...
										<div class="card-header">
											<div class="d-flex align-items-center">
												...
												<div>
													...
													<p class="fs-12 fw-medium mb-0"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="5f283e2d2d3a311f3a273e322f333a713c3032">[email&#160;protected]</a></p>
												</div>
											</div>
										</div>
										<div class="card-body">
						...
						<div class="tab-content" id="v-pills-tabContent">
							...
							<div class="tab-pane fade  show active" id="layout">
								<ul>
									...
									<li><a href="layout-dark.html" class="active"><span>Dark</span></a></li>
								</ul>
							</div>
							...
							<div class="tab-content">
								...
								<div class="tab-pane fade show active" id="menu-layout">
									<ul class="stack-submenu">
										...
										<li><a href="layout-dark.html" class="active">Dark</a></li>
									</ul>
								</div>
