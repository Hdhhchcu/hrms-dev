										...
										<div class="card-header">
											<div class="d-flex align-items-center">
												...
												<div>
													...
													<p class="fs-12 fw-medium mb-0"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="8bfceaf9f9eee5cbeef3eae6fbe7eea5e8e4e6">[email&#160;protected]</a></p>
												</div>
											</div>
										</div>
										<div class="card-body">
				...
				<div class="twocol-mini">		
					...
					<div class="sidebar-left slimscroll">
						<div class="nav flex-column align-items-center nav-pills" id="sidebar-tabs" role="tablist" aria-orientation="vertical">
							<a  href="javascript:void(0);" class="nav-link active" title="Dashboard" data-bs-toggle="tab" data-bs-target="#dashboard">
								<i class="ti ti-smart-home"></i>
							</a>
							<a  href="javascript:void(0);" class="nav-link" title="Apps" data-bs-toggle="tab" data-bs-target="#application">
								<i class="ti ti-layout-grid-add"></i>
							</a>
							<a href="javascript:void(0);" class="nav-link" title="Super Admin" data-bs-toggle="tab" data-bs-target="#super-admin">
								<i class="ti ti-user-star"></i>
							</a>
							<a href="javascript:void(0);" class="nav-link" title="Layout" data-bs-toggle="tab" data-bs-target="#layout">
								<i class="ti ti-layout-board-split"></i>
							</a>
							<a href="javascript:void(0);" class="nav-link" title="Content" data-bs-toggle="tab" data-bs-target="#content">
								<i class="ti ti-license"></i>
							</a>
							<a href="javascript:void(0);" class="nav-link" title="Pages" data-bs-toggle="tab" data-bs-target="#pages">
								<i class="ti ti-page-break"></i>
							</a>
							<a href="javascript:void(0);" class="nav-link" title="Authentication" data-bs-toggle="tab" data-bs-target="#authentication">
								<i class="ti ti-lock-check"></i>
							</a>
							<a href="javascript:void(0);" class="nav-link" title="UI Elements" data-bs-toggle="tab" data-bs-target="#ui-elements">
									...
									<div class="shadow-md bg-white rounded p-2 mb-4">
										<div class="d-flex align-items-center">
											...
											<div>
												...
												<p><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="2c6642441f181f6c49544d415c4049024f4341">[email&#160;protected]</a></p>
											</div>
										</div>
									</div>
															...
															<div class="d-flex align-items-center">
																...
																<div class="dropdown">
																	...
																	<ul class="dropdown-menu dropdown-menu-end">
																		<li>
																			<a class="dropdown-item" href="javascript:void(0);"><span class="text-gray">From :</span> Arman Janes <span class="__cf_email__" data-cfemail="0a6b78676b64393e394a6f726b677a666f24696567">[email&#160;protected]</span></a>
																		</li>
																		<li>
																			<a class="dropdown-item" href="javascript:void(0);"><span class="text-gray">To :</span> Angela Thomas <span class="__cf_email__" data-cfemail="e687888183d2d3d0d3a6839e878b968a83c885898b">[email&#160;protected]</span></a>
																		</li>
																		<li>
